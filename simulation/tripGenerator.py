...
#
# f.write(
#     "<vType id=\"abnormal3\" vClass=\"passenger\"  speedFactor=\"normc(1,0.1,0.9,1.1)\" speedDev=\"0.1\" accel=\"7\" decel=\"8\" minGap=\"0.5\" color=\"1,0,0\" sigma=\"0.05\" maxSpeed=\"140\" tau=\"1\" "
#     "lcStrategic=\"1\" lcSpeedGain=\"1\" lcKeepRight=\"0\" lcOpposite=\"1\"/>\n")
#

f.write(
    "<vType id=\"abnormal1\" vClass=\"passenger\" speedFactor=\"normc(1.2,0.1,1.15,1.25)\" speedDev=\"0.1\" accel=\"7\" "
    "decel=\"8\" minGap=\"0.5\" color=\"1,0,0\" sigma=\"0.9\" maxSpeed=\"140\"  "
    "lcStrategic=\"1\" lcSpeedGain=\"1\" lcKeepRight=\"0\" lcOpposite=\"1\"/>\n")

f.write(
    "<vType id=\"abnormal2\" vClass=\"passenger\"  speedFactor=\"normc(1.2,0.1,1.15,1.25)\"  speedDev=\"0.1\" accel=\"8\" "
    "decel=\"9\" minGap=\"0.5\" color=\"1,0,0\" sigma=\"0.9\" maxSpeed=\"140\" "
    "lcStrategic=\"1\" lcSpeedGain=\"1\" lcKeepRight=\"0\" lcOpposite=\"1\" impatience=\"1\" lcPushy=\"1\"/>\n")

for i in range(0, 36000000, 300):
    a = random.randint(0, 12)
    c = random.randint(1, 3)
    s = random.randint(0, 3)
    for j in range(0, 5):
        cl = f'veh_passenger{1}'
        # _from = f'calgary{2 * s + 1}'
        # _to = f'calgary{2 * s + 2}'
        _from = 'gneE2'
        _to = 'gneE3'
        # if j == a:
        #     cl = 'abnormal2'
        f.write(
            f'<trip id=\"calgary{s}{k * 10 + j}\"  type=\"{cl}\" depart=\"{i + j*3}.00\"  departLane=\"random\" departSpeed=\"max\" from=\"{_from}\" to=\"{_to}\" />\n')
    k += 1
